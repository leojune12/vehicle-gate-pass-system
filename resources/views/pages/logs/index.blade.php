                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        <div class="flex items-center">
                            <input type="text" name="name" id="name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Name">

                            <select id="log_type" name="log_type" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="">Select Log Type</option>
                                @foreach ($log_types as $log_type)
                                    <option
                                        @if ($log_type) != null)
                                            {{ $log_type == @$user->log_type ? "selected" : "" }}
                                        @endif
                                    >
                                        {{ $log_type->log_type }}
                                    </option>
